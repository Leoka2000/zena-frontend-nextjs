...
import { getToken } from "@/lib/auth" // Import your token getter function
...
export const AccelerometerChart = ({ liveData }) => {
  ...
  const fetchHistory = React.useCallback(async () => {
    try {
      ...
      const res = await axios.get(`http://localhost:8080/api/accelerometer/history?range=${range}`, {
        headers: {
